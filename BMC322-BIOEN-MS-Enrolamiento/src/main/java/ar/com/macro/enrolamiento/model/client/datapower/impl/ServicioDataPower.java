...
public class ServicioDataPower {
     ...
     */
    public ResponseEntity<String> ejecutarGetDataPower(String servicio, MultiValueMap<String, String> parameters,
    ...
    private ResponseEntity<String> invocarServicio(String uri, HttpMethod method, HttpEntity<?> entidadHttp) {
        ...
        try {
            ...
            log.info("Request DataPower url: {}, Request DataPower body: {}, Request DataPower headers: {}",
            ...
            log.info("Response DataPower url: {}, Response DataPower duracion: {} ms, {}",
                    new Object[] { uri, duration, duration });
            if (response == null || response.getStatusCode() == null) {
                throw new ComunicacionFallidaException(Errores.DATAPOWER_NO_DISPONIBLE.getCodigo(),
                        Errores.DATAPOWER_NO_DISPONIBLE.getMensaje());
            }
            ...
            duration = System.currentTimeMillis() - start;
            log.info("Response DataPower HttpServerErrorException url: {}, duracion: {} ms, {}",
                    new Object[] { uri, duration, duration });
            ...
            duration = System.currentTimeMillis() - start;
            log.info("Response DataPower ResourceAccessException url: {}, duracion: {} ms, {}",
                    new Object[] { uri, duration, duration });
            throw new ComunicacionFallidaException(Errores.DATAPOWER_NO_DISPONIBLE.getCodigo(), var24.getMessage(),
                    var24);
        } catch (Exception e) {
            throw new ComunicacionFallidaException(Errores.DATAPOWER_NO_DISPONIBLE.getCodigo(),
                    Errores.DATAPOWER_NO_DISPONIBLE.getMensaje());
    ...
    public <T> T procesarRespuesta(ResponseEntity<String> response, Class<?> aClass) {
        ...
        try {
            return ConvertidorUtil.json2Class(response.getBody(), aClass);
        } catch (Exception e) {
            throw new ComunicacionFallidaException(Errores.DATAPOWER_INFORMACION_NO_ENCONTRADA.getCodigo(),
                    Errores.DATAPOWER_INFORMACION_NO_ENCONTRADA.getMensaje());
        }
    }
}
