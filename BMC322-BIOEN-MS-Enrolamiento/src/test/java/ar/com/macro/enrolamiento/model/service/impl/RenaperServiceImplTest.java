...
import ar.com.macro.enrolamiento.model.client.renaper.dto.soap.*;
...
public class RenaperServiceImplTest {
	...
	public void debeValidarHuellaEnRenaperGenerarTransaccionHuellaException() throws Exception, JsonProcessingException {
	...
	@Test(expected = RenaperException.class)
	public void debeValidarHuellaEnRenaperTCNInvalido1Exception() throws Exception, JsonProcessingException {
	...
	@Test(expected = RenaperException.class)
	public void debeValidarHuellaEnRenaperTCNInvalido2Exception() throws Exception, JsonProcessingException {
	...
	@Test
	public void debeValidarHuellaEnRenaperExito() throws Exception, JsonProcessingException {
