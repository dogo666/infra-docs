...
public class DaonClientMTLSConfig {
    ...
    @Value("${daonengine.mtls.actived}")
    private String daonengineMtlsActived;

    private final String DAON_SETUP = "daon-setup";

    public DaonClientMTLSConfig(){
        log.info("daonengine.mtls.actived = " + daonengineMtlsActived);
    }
