...
public class ConsultarIdentidadRequest  {
	...
	@Pattern(regexp = "\\d{1,9}", message = "{api.validacion.ConsultarIdentidadRequest.dni.pattern.message}")
	private String dni;

    @Schema(description = "Sexo del cliente")
	@Pattern(regexp = "[A-Z]{1}", message = "{api.validacion.ConsultarIdentidadRequest.sexo.pattern.message}")
	private String sexo;
