...
import ar.com.macro.validacion.model.client.esb.impl.ServicioESB;
...
public class RenaperClientImpl extends ServicioESB implements RenaperClient {
    ...
    public Optional<ValidarRostroRenaperClientResponse> validarRostro(ValidarRostroRenaperClientRequest validarRostroRenaperClientRequest){
        return Optional.of(consumirServicioRenaper(urlServicioRenaperRostro, validarRostroRenaperClientRequest,  headersRenaperValidacionPorRostro, ValidarRostroRenaperClientResponse.class));
    }

    private <T> T consumirServicioRenaper(String servicioRenaperAConsumir, Object request, Map<String, String> headersRenaper, Class claseRespuesta) {
        try{
