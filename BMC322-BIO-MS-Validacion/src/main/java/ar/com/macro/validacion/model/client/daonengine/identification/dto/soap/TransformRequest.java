...
/**
 * Transform the data according to the policy specified <p>
 * 
 ...
 *         &lt;element name="TransformPolicyIdentifier" type="{http://www.daon.com/ws/de}PolicyIdentifier" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Identity" type="{http://www.daon.com/ws/de}Identity" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "TransformRequest")
    ...
    extends AbstractRequest
{
    ...
    protected List<PolicyIdentifier> transformPolicyIdentifier;
     ...
     * This is why there is not a <CODE>set</CODE> method for the transformPolicyIdentifier property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTransformPolicyIdentifier().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PolicyIdentifier> getTransformPolicyIdentifier() {
        if (transformPolicyIdentifier == null) {
            transformPolicyIdentifier = new ArrayList<PolicyIdentifier>();
        }
        return this.transformPolicyIdentifier;
    }
