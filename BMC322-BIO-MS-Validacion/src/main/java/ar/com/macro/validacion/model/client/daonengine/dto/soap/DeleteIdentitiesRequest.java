...
/**
 * Delete the specified Identities.
 * 
 * 							This is an atomic operation - if an error occurs
 * 							deleting any of the Identities specified then no
 * 							Identities will be deleted. If there is no error
 * 							then all the Identities specified will be deleted.
 * 						
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DomainDelete" maxOccurs="unbounded"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
...
@XmlRootElement(name = "DeleteIdentitiesRequest")
public class DeleteIdentitiesRequest
    extends AbstractRequest
{

    @XmlElement(name = "DomainDelete", required = true)
    protected List<DomainDelete> domainDelete;

    /**
     * Gets the value of the domainDelete property.
     *
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the domainDelete property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDomainDelete().add(newItem);
     * </pre>
     *
     *
     * <p>
     ...
     *
     */
    public List<DomainDelete> getDomainDelete() {
        if (domainDelete == null) {
            domainDelete = new ArrayList<DomainDelete>();
        }
    ...
    public static class DomainDelete {
