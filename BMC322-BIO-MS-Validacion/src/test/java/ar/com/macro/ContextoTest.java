...
public abstract class ContextoTest {
    ...
    @MockBean
    protected FidoService fidoService;
    ...
    protected MvcResult ejecutarRequestConParamsNoBodyOpId(HttpMethod metodoHttp, String URI, MultiValueMap<String, String> params, 
    ...
    protected MvcResult ejecutarPostConHeader(String URI, String request, ResultMatcher statusRespuestaEsperado, String xOperationIdValue) throws Exception {
    ...
    protected MvcResult ejecutarPostConHeaderResponseEmpty(String URI, String request, ResultMatcher statusRespuestaEsperado, String xOperationIdValue ) throws Exception {
        return this.mockMvc.perform(MockMvcRequestBuilders.post(URI)
                .header(HeaderConstants.HEADER_X_OPERATION_ID, xOperationIdValue)
                .content(request)
                .contentType(MediaType.APPLICATION_JSON_VALUE))
